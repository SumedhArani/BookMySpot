                        ...
                        <div class="col-md-4">
                            <div class="single_widget wow fadeIn" data-wow-duration="5s">
                                ...
                                <div class="single_widget_form text-left">
                                    <form action="authenticate.php" id="formid" method="post">
...
<div class="col-md-4">
                            <div class="single_widget wow fadeIn" data-wow-duration="5s">
                                ...
                                <div class="single_widget_form text-left">
                                    <form action="update.php" id="formid" method="post">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="DOB" placeholder="DOB YYYY-MM-DD" required="">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="identity_proof" placeholder="Identity Proof" required="">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control" name="message" rows="3" placeholder="Re-type Password">
                                        </div>
