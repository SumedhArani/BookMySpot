                            ...
                            <div class="col-md-12">
                                <div class="main_slider_content wow zoomIn" data-wow-duration="1s">
                                    ...
                                    <a href="#portfolio" style="color: white;">
                                        <button class="btn-lg">Click here to book</button>
                                    </a>
                                </div>
                            </div>	
                        </div>
                    ...
                    <div class="abouts_content">
                        ...
                        <div class="col-md-6">
                            <div class="single_abouts_text wow slideInRight" data-wow-duration="1s">
                                <h4>About us</h4>
                                <h3>BookMySpot</h3>
                                <p>The purpose for developing this software is to facilitate everyone who is concerned with the parking allotment.</p>

                                <p>BookMySpot will minimize the time and effort required by the consumers in parking their vehicles. It will also help our clients in managing the parking space efficiently and improve the convenience factor.</p>
                        ...
                        <div class="main_mobail_apps_content wow zoomIn">
                            ...
                            <div class="col-md-7 col-sm-12">
                                <div class="single_monail_apps_text">
                                    ...
                                    <h1>Mobile App <span>is coming soon.</span></h1>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="copyright wow zoomIn" data-wow-duration="3s">
							<p>Made with <i class="fa fa-heart"></i> by <a href="https://www.github.com/SumedhArani/BookMySpot">Team 5</a>2017. All Rights Reserved</p>
						</div>
                    </div>
                </div>
            </div>
